  ...
  return (
    <div className="w-full max-w-[72rem] mx-auto mt-10">
      <div className="flex flex-col items-center text-center not-italic px-4">
        ...
        <h1 className="md:text-[3.8rem] text-[2rem] [text-wrap:balance] text-center text-[#171e3d] md:font-[700] font-[700] md:leading-[137.097%] leading-normal tracking-[-0.125rem] mt-2 sm:mt-4 md:mt-8">
        ...
        <h3 className="md:text-[1.4375rem] text-[1rem] font-[600] text-[#161E42] leading-[121.739%] mt-2 sm:mt-4 md:mt-6 [text-wrap:balance]">
